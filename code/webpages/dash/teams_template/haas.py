...
layout = html.Div([
    ...
    html.Div([
        html.Div([
            ...
            html.P("Haas joined F1 in 2016 as the first American team in many years. Initially they found decent results but by the time 2018 came around they were a force in the midfield, regularly finishing best of the rest and finishing 5th in the constructors. However after rough years in 2019 and 2020 Haas must go back to the drawing board and come with a new approach or their journey could already be over."),
    ...
    html.Div([
        html.Div([
            html.H3('2020 Season'),
            html.P("Haas came into the 2020 season under immense pressure, some fans were not happy that the team hadn't gotten rid of Grosjean and the constant talk around whether the team would be sold or not was following the team everywhere. Grosjean picked up his only points at the Nurburgring at the Eifel Grand Prix with an excellent 9th place finish, Magnussen's point came in Hungary with a hard fought 10th place finish."),
