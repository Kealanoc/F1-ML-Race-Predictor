...
results = pd.read_csv("../webpages/dash/static/Data/RaceResults.csv")
quali = pd.read_csv("../webpages/dash/static/Data/QualifyingResults.csv")
driver_standings = pd.read_csv("../webpages/dash/static/Data/DriverStandings.csv")
constructor_standings = pd.read_csv("../webpages/dash/static/Data/ConstructorStandings.csv")
weather = pd.read_csv("../webpages/dash/static/Data/Weather.csv")
...
complete_df = pd.merge(dataframe_4, quali, how="inner", on=["Season", "Round", "Pos"]).drop(["Car", "driver"], axis=1)
...
for columns in ['DriverPoints', 'DriverWins', 'DriverStandings', 'ConstructorPoints', 
            'ConstructorWins' , 'ConstructorStandings']:
...
df.to_csv("../webpages/dash/static/Data/CompleteDF.csv", index=False)
print(df.shape)