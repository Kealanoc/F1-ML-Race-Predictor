...
race = race.drop(["Season", "Round", "Track_ID", "DOB", "Nationality", "Pos", "Time", "Status", "Points", "URL", "Podium"], axis=1)
redbull = {}
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Red_Bull"), index=False)
mercedes = {}
for i in range(len(race)):
    driver = race.Driver[i]
    team = str(race.Constructor[i])
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Mercedes"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Mclaren"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Renault"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Alfa"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Alphatauri"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Haas"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Williams"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Ferrari"), index=False)
...
df.to_csv("../webpages/dash/static/Data/TeamLineups/{}.csv".format("Racing_Point"), index=False)